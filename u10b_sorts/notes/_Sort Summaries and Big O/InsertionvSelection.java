public class InsertionvSelection
{
    public static void main(String[] args)
    {
        ...
        */
        ...
        System.out.printf("Time elapsed:  %,d nanoseconds.%n",newtimeElapsed);
    ...
    {
        long diff = Math.abs(selectionTime - insertionTime);
        double percentDiff = 100 * diff / Math.max(selectionTime,insertionTime);
        if(selectionTime > insertionTime)
        {
            System.out.printf("Insertion time is faster than Selection time by %,d nanoseconds.\n", diff);
            System.out.printf("Insertion is %.1f%% faster.\n",percentDiff);
        }
        else
        {
            System.out.printf("Selection time is faster than Insertion time by %,d nanoseconds.\n", diff);
            System.out.printf("Selection is %.1f%% faster\n.",percentDiff);
        }
    }
