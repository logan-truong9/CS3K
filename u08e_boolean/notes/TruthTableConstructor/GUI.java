...
public class GUI extends JFrame implements Runnable {
    ...
    public GUI(final ApplicationStarter appStarter) {
        ...
        addComponentListener(new ComponentAdapter() {
            public void componentResized(final ComponentEvent e) {
                int width = getWidth(),
                    height = getHeight();
                final int minWidth = Integer.parseInt(bundle.getString("MIN_WINDOW_WIDTH")), minHeight = Integer.parseInt(bundle.getString("MIN_WINDOW_HEIGHT"));
                if (width < minWidth)
                    width = minWidth;
                if (height < minHeight)
                    height = minHeight;
        ...
        setSize(Integer.parseInt(bundle.getString("DEFAULT_WINDOW_WIDTH")),
    ...
    private void initializeStatusPanel(final boolean useProgressBar) {
        ...
        statusPanel.setBorder(BorderFactory.createTitledBorder(new EtchedBorder()));
        final GridBagConstraints gbc = new GridBagConstraints();
        gbc.ipady = -2;
        ...
        final Dimension theSize = new Dimension(5, 15);
